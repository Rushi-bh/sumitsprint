...
//	scenario - 5
	...
	public void user_failed_to_check_prices() {
	   String actualErrorTo = packersAndMoversPage.errorTo.getText();
	   String expectedErrorTo = "Moving from and to cities can not be same";
	   String actualErrorMobile = packersAndMoversPage.errorMobile.getText();
	   String expectedErrorMobile = "Mobile no. should be 10 digits";
...
//	   Assert.assertEquals(actualErrorMobile, "Mobile no. should be 10 digits");
	   packersAndMoversPage.assertEquals(actualErrorTo,expectedErrorTo);
	   packersAndMoversPage.assertEquals(actualErrorMobile,expectedErrorMobile);
	   tearDown();
	}
